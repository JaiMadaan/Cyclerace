...
function pinkCyclists(){
        player1 =createSprite(1100,Math.round(random(width/2, height/2-469)));
        player1.scale =0.1;
...
function yellowCyclists(){
        player2 =createSprite(1100,Math.round(random(width/2, height/2)));
        player2.scale =0.1;
...
function redCyclists(){
        player3 =createSprite(1100,Math.round(random(width/2, height/2)));
        player3.scale =0.1;
